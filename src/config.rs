...
impl RadarConfig {
    ...
    #[require(Unlocked)]
    #[switch_to(Locked)]
    pub fn lock(self) -> RadarConfig {
        RadarConfig {
            inner: self.inner,
            num_subsweep: self.num_subsweep,
        }
    }

    #[require(Locked)]
    #[switch_to(Unlocked)]
    pub fn unlock(self) -> RadarConfig {
        RadarConfig {
            inner: self.inner,
            num_subsweep: self.num_subsweep,
        }
    ...
    #[require(Unlocked)]
    pub fn set_sweep_mode(self, sweep_mode: SweepMode) -> Result<RadarConfig, ConfigError> {
        match sweep_mode {
            SweepMode::Continuous { sweep_rate } => {
                // Do all operations directly to avoid ownership issues
                ...
                unsafe {
                    acc_config_continuous_sweep_mode_set(self.inner, true);
                    acc_config_sweep_rate_set(self.inner, sweep_rate);
                }
            }
            SweepMode::Discrete {
                frame_rate,
                ...
                acc_config_continuous_sweep_mode_set(self.inner, false);
                match frame_rate {
                    FrameRate::Unlimited => acc_config_frame_rate_set(self.inner, 0.0),
                    FrameRate::Limited(rate) => acc_config_frame_rate_set(self.inner, rate),
                }
                acc_config_sweeps_per_frame_set(self.inner, sweeps_per_frame);
            },
        }
        Ok(RadarConfig {
            inner: self.inner,
    ...
    #[require(Unlocked)]
    pub fn set_start_point(self, start_point: i32) -> RadarConfig {
    ...
    #[require(Unlocked)]
    pub fn set_num_points(self, num_points: u16) -> RadarConfig {
    ...
    #[require(Unlocked)]
    pub fn set_step_length(self, step_length: u16) -> RadarConfig {
    ...
    #[require(Unlocked)]
    pub fn set_profile(self, profile: RadarProfile) -> RadarConfig {
    ...
    #[require(Unlocked)]
    pub fn set_hwaas(self, hwaas: Hwaas) -> Result<RadarConfig, ConfigError> {
    ...
    #[require(Unlocked)]
    pub fn receiver_gain_set(self, receiver_gain: u8) -> RadarConfig {
    ...
    #[require(Unlocked)]
    pub fn set_sweeps_per_frame(self, sweeps_per_frame: u16) -> RadarConfig {
    ...
    #[require(Unlocked)]
    pub fn set_prf(self, prf: PulseRepetitionFrequency) -> RadarConfig {
    ...
    #[require(Unlocked)]
    pub fn set_phase_enhancement(self, enable: bool) -> RadarConfig {
    ...
    #[require(Unlocked)]
    pub fn set_loopback(self, enable: bool) -> RadarConfig {
    ...
    #[require(Unlocked)]
    pub fn set_double_buffering(self, enable: bool) -> RadarConfig {
    ...
    #[require(Unlocked)]
    pub fn set_frame_rate(self, frame_rate: FrameRate) -> RadarConfig {
        match frame_rate {
    ...
    #[require(Unlocked)]
    pub fn set_transmitter_enabled(self, enable: bool) -> RadarConfig {
    ...
    #[require(Unlocked)]
    pub fn set_inter_frame_idle_state(self, idle_state: RadarIdleState) -> RadarConfig {
    ...
    #[require(Unlocked)]
    pub fn set_inter_sweep_idle_state(self, idle_state: RadarIdleState) -> RadarConfig {
    ...
    #[require(Unlocked)]
    fn set_continuous_sweep_mode(self, enabled: bool) -> Result<RadarConfig, ConfigError> {
        if enabled {
            if self.frame_rate().is_limited() {
                return Err(ContinuousSweepMode);
            }
    ...
    #[require(Unlocked)]
    fn set_sweep_rate(self, sweep_rate: f32) -> Result<RadarConfig, ConfigError> {
        if sweep_rate.is_zero() || sweep_rate.is_sign_negative() {
            return Err(ConfigError::SweepRate);
        }
